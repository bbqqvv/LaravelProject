...
<head>
    ...
    <title>ROWAY Dashboard | Two Columns Sidebar</title>
    ...
    setColors(color);" :class="{ 'dark': isDark }" @resize.window="watchScreen()">
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            ...
            <div x-show="isSidebarOpen" @click="isSidebarOpen = false"
                class="fixed inset-0 z-10 bg-primary-darker lg:hidden" style="opacity: 0.5" aria-hidden="true"></div>
                    ...
                    <div class="relative flex items-center justify-center flex-shrink-0 px-2 py-4 space-x-4">
                        ...
                        <div class="" x-data="{ open: false }">
                            <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
                                ...
                                <img class="w-12 h-12 rounded-full" src="../build/images/avatar.jpg"
                                    alt="Ahmed Kamel" />
                            </button>
            ...
            <section x-show="isSecondSidebarOpen"
                x-transition:enter="transition-all transform duration-300 ease-in-out"
                x-transition:enter-start="-translate-x-full opacity-0"
                x-transition:enter-end="translate-x-0 opacity-100"
                x-transition:leave="transition-all transform duration-300 ease-in-out"
                x-transition:leave-start="translate-x-0 opacity-100"
                x-transition:leave-end="-translate-x-full opacity-0" x-ref="secondSidebar"
                @keydown.escape="window.innerWidth <= 1024 ? isSecondSidebarOpen = false : ''" tabindex="-1"
