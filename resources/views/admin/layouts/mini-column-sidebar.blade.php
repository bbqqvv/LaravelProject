    ...
    setColors(color);" :class="{ 'dark': isDark }" @resize.window="watchScreen()">
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            ...
            <div x-show="isSidebarOpen" @click="isSidebarOpen = false"
                class="fixed inset-0 z-10 bg-primary-darker md:hidden" style="opacity: 0.5" aria-hidden="true"></div>
            ...
            <aside x-show="isSidebarOpen" x-transition:enter="transition-all transform duration-300 ease-in-out"
                ...
                @keydown.escape="window.innerWidth <= 768 ? isSidebarOpen = false : ''" tabindex="-1"
                    ...
                    <div class="flex flex-col h-screen">
                        ...
                        <div class="flex-1 p-4 space-y-8 overflow-y-hidden hover:overflow-y-auto">
                            ...
                            <div class="flex flex-col items-center space-y-2">
                                <!-- User avatar -->
                                <img class="w-20 h-20 rounded-full dark:opacity-70" src="../build/images/avatar.jpg"
                                    alt="Ahmed Kamel" />
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    <a href="#" class="flex items-start space-x-2 group">
                                        ...
                                        <span
                                            class="text-xs text-gray-500 whitespace-nowrap dark:text-primary-light">1h
                                            ago</span>
                                    </a>
                                    <a href="#" class="flex items-start space-x-2 group">
                                        <img class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
