    ...
    <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                        ...
                        <a href="#" @click="$event.preventDefault(); open = !open"
                            ...
                            <span aria-hidden="true">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 2a5 5 0 00-5 5v10a5 5 0 0010 0V7a5 5 0 00-5-5z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
            ...
            <footer
                ...
                <div>ROWAY &copy; 2024</div>
                <div>
                    Made by
                    <a href="https://github.com/bbqqvv" target="_blank" class="text-blue-500 hover:underline">VAN
                        BUII</a>
                </div>
            </footer>
        </div>
                        ...
                        <a href="#" class="block">
                            <div class="flex px-4 space-x-4">
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                        Shared new project "ROWAY Dashboard"
                                    </p>
                        ...
                        <a href="#" class="block">
                            <div class="flex px-4 space-x-4">
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                        Commit new changes to ROWAY Dashboard project.
                                    </p>
                        ...
                        <a href="#" class="block">
                            <div class="flex px-4 space-x-4">
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                        Release new version "ROWAY Dashboard"
                                    </p>
            ...
            <div class="flex flex-col h-screen">
                ...
                <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
                    ...
                    <a href="#" class="flex space-x-4">
                        ...
                        <div class="flex-1 max-w-xs overflow-hidden">
                            <h4 class="text-sm font-semibold text-gray-600 dark:text-light">ROWAY Dashboard</h4>
                            <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                    ...
                    <template x-for="i in 10" x-key="i">
                        <a href="#" class="flex space-x-4">
                            ...
                            <div class="flex-1 max-w-xs overflow-hidden">
                                <h4 class="text-sm font-semibold text-gray-600 dark:text-light">ROWAY Dashboard
                                </h4>
                                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                </p>
